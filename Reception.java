    ...
    public Reception(){
        ...
        btnNewButton_3.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try{
                    //error ---------------------
                    hotel.management.system.CustomerInfo customer = new hotel.management.system.CustomerInfo();
        ...
        btnNewButton_4.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                hotel.management.system.CheckOut check;
                try {
                    check = new hotel.management.system.CheckOut();
